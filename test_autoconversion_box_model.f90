...
! KK2000
  ...
  subroutine kk2000_autoconversion(qc,nc,auto,nauto)
...
! SB2001 autoconversion
  ...
  subroutine sb2001_autoconversion(qc,nc,qr,auto,nauto)
...
! NOTE the latter is NOT M3, but bulk mass (so, factor of pi/6*rhow different from M3).
  ...
  subroutine berry_reinhardt_autoconversion(rc,nc,prr_wau,pnr_wau)
